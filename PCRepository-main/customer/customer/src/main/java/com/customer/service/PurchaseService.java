...
public class PurchaseService {
    ...
    public Purchase makePurchase(Bean bean)  throws PurchaseNotfoundexception, CustomerNotFoundException {
        ...
        Product product = rTemplate.getForObject("http://localhost:9094/client2/product/" + bean.getProductId(), Product.class);
        if(product == null)
        {
        ...
        rTemplate.put("http://localhost:9094/client2/product/removefromstock/" + bean.getProductId() + "/" + bean.getQuantity(), Product.class);
